...
urlpatterns = [
    ...
    path('ft_enable1/<str:pk>/<str:compute1_name>/<str:compute2_name>/', views.ft_enable1, name='ft_enable1'),
    path('<int:pk>/ft_enable/', views.ft_enable, name='ft_enable'),
    path('<int:pk>/ft_disable/', views.ft_disable, name='ft_disable'),
